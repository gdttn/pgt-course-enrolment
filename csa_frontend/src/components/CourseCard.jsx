...
function CourseCard({
  ...
  const noteState = note.message.length !== 0 ? false : true;
  ...
  return (
    <div>
      ...
      {isDefault ? (
        <div
          className={`${
            noteState ? "rounded-lg " : "rounded-lg"
          } items-center ring-1 ring-gray-400 ring-offset-1 space-x-2 mt-2 bg-white cursor-default shadow-md `}
        >
        ...
        <div className="flex flex-row flex-wrap">
          ...
          <div className="rounded-t-lg p-1 bg-gray-100">
                <a href={url} className="text-blue-600 text-sm  py-1 px-2" target="_blank">
                  {courseCode}
                </a> 
                <span className="text-darkBlue text-sm font-bold rounded-md py-1 px-2 ">{courseName}</span>
              </div>
          </div>
        ...
        <div
          ...
          className={`flex flex-col ${
            noteState ? "rounded-md p-3 " : "rounded-md p-1"
          }  my-2 ${isSelected ? "ring-4 ring-green-200 ring-offset-1 text-green-700 bg-green-100" : " bg-white"} ${
            ...
            <div className="flex flex-col flex-grow rounded-full items-baseline ">
              ...
              <div className="md:flex flex-grow space-x-2 py-1">
                ...
                {note.message.length !== 0 ? (
                  <div className="flex flex-grow self-start rounded-full bg-red-100 mx-2">
                    <a
                      href={note.url}
                      target="_blank"
                      data-tooltip-id="my-tooltip"
                      data-tooltip-content={note.message}
